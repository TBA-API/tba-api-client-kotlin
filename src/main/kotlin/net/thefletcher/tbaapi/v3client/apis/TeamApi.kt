...
class TeamApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getTeam(teamKey: kotlin.String, ifMinusModifiedMinusSince: kotlin.String?) : Team {
        ...
        val localVarResponse = request<Team>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    ...
    fun getTeamMediaByTag(teamKey: kotlin.String, mediaTag: kotlin.String, ifMinusModifiedMinusSince: kotlin.String?) : kotlin.Array<Media> {
        ...
        val localVarResponse = request<kotlin.Array<Media>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Media>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun getTeamRobots(teamKey: kotlin.String, ifMinusModifiedMinusSince: kotlin.String?) : kotlin.Array<TeamRobot> {
        ...
        val localVarResponse = request<kotlin.Array<TeamRobot>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<TeamRobot>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun getTeamSimple(teamKey: kotlin.String, ifMinusModifiedMinusSince: kotlin.String?) : TeamSimple {
        ...
        val localVarResponse = request<TeamSimple>(
            localVariableConfig,
            localVariableBody
        )
