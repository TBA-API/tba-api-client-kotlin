...
import net.thefletcher.tbaapi.v3client.models.Elimination_Alliance
import net.thefletcher.tbaapi.v3client.models.Event
import net.thefletcher.tbaapi.v3client.models.Event_District_Points
import net.thefletcher.tbaapi.v3client.models.Event_Insights
import net.thefletcher.tbaapi.v3client.models.Event_OPRs
import net.thefletcher.tbaapi.v3client.models.Event_Predictions
import net.thefletcher.tbaapi.v3client.models.Event_Ranking
...
class EventApi(basePath: kotlin.String = "https://www.thebluealliance.com/api/v3") : ApiClient(basePath) {
    ...
    * @param eventKey TBA Event Key, eg &#x60;2016nytr&#x60; 
    * @param ifModifiedSince Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)
    * @return kotlin.Array<Elimination_Alliance>
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventAlliances(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : kotlin.Array<Elimination_Alliance> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<kotlin.Array<Elimination_Alliance>>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as kotlin.Array<Elimination_Alliance>
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventInsights(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : Event_Insights {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<Event_Insights>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Event_Insights
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventOPRs(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : Event_OPRs {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<Event_OPRs>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Event_OPRs
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventPredictions(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : Event_Predictions {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<Event_Predictions>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Event_Predictions
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventRankings(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : Event_Ranking {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<Event_Ranking>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Event_Ranking
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getEventSimple(eventKey: kotlin.String, ifModifiedSince: kotlin.String) : Event_Simple {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf("ifModifiedSince" to ifModifiedSince)
        val localVariableConfig = RequestConfig(
        ...
        val response = request<Event_Simple>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Event_Simple
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
